...
export default function AdminPage() {
	...
	return (
		<div className="flex flex-col md:flex-row h-screen">
			{/* Mobile Header */}
			<header className="md:hidden p-4 border-b flex items-center justify-between">
			...
			{/* Sidebar */}
			<aside
				className={`fixed inset-y-0 left-0 w-64 bg-white border-r border-gray-200 space-y-2 p-4 z-40 transform transition-transform duration-200 ${
			...
			>
				...
				<nav className="flex flex-col space-y-2 text-sm">
					<button
						...
						className={`text-left px-3 py-2 rounded hover:bg-gray-100 ${activeTab === "overview" ? "bg-gray-200 font-semibold" : ""}`}
					>
						Overview
					</button>
					<button
						...
						className={`text-left px-3 py-2 rounded hover:bg-gray-100 ${activeTab === "users" ? "bg-gray-200 font-semibold" : ""}`}
					>
						Users
					</button>
					<button
						...
						className={`text-left px-3 py-2 rounded hover:bg-gray-100 ${activeTab === "posts" ? "bg-gray-200 font-semibold" : ""}`}
					>
						Posts
					</button>
					<button
						...
						className={`text-left px-3 py-2 rounded hover:bg-gray-100 ${activeTab === "comments" ? "bg-gray-200 font-semibold" : ""}`}
					>
						Comments
					</button>
					<button
						...
						className={`text-left px-3 py-2 rounded hover:bg-gray-100 ${activeTab === "reports" ? "bg-gray-200 font-semibold" : ""}`}
					>
						Reports
					</button>
					<button
						...
						className={`text-left px-3 py-2 rounded hover:bg-gray-100 ${activeTab === "feedback" ? "bg-gray-200 font-semibold" : ""}`}
					>
						Feedback
					</button>
				</nav>
			...
			{/* Main Content */}
			<main className="flex-1 p-6 overflow-auto mt-4 md:mt-0">
				{activeTab === "overview" && (
					<Overview
